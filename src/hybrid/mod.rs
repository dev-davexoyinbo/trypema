/// Absolute (deterministic sliding-window) hybrid rate limiter.
pub mod absolute_hybrid_rate_limiter;
...
/// Suppressed (probabilistic) hybrid rate limiter.
pub mod suppressed_hybrid_rate_limiter;
